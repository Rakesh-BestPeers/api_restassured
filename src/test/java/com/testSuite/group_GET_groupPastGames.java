...
public class group_GET_groupPastGames extends TestBase {
	...
	public void gamecardProps() throws JsonProcessingException {
		if (test == null) {
			test = extent.createTest("Grizzly Admin Should be able to get groups past games list");
			extentTest.set(test);
			flag = true;
		}
		extentTest.get().log(Status.INFO, "Grizzly Admin Should be able to get groups past games list");
		response = (Response) requests.getUsers(
				"/api/users/55727957-3c6d-4219-b67f-a730fbabd6d8/groups/662ad7bf-d1b6-4fc4-9166-0941a4d53a1a/games/past",
				extentTest.get());
		System.out.println(response.body().prettyPeek());

		log = extentTest.get().createNode("To Verify Status Code :: groups past games");
