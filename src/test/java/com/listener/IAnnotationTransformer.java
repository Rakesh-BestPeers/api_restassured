...
public interface IAnnotationTransformer extends ITestNGListener {
	 ...
	 * @param testClass
	 *            If the annotation was found on a class, this parameter represents
	 *            this class (null otherwise).
	 ...
	 * @param testMethod
	 *            If the annotation was found on a method, this parameter represents
	 *            this method (null otherwise).
	 */
	default void transform(ITestAnnotation annotation, Class testClass, Constructor testConstructor,
			Method testMethod) {
		// not implemented
	}
}
